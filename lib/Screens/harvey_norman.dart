...
class HarveyNorman extends StatelessWidget {
  HarveyNorman({super.key});
  final bool isWindows = Platform.isWindows;
  final Services service = Get.find<Services>();
  String siteName = 'Harvey Norman';
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  ? 'Price: AUD ${itemDocuments[index]['productPrice'].toString()}'
                                  : 'Wating for next run',
